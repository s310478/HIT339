...
namespace Assignment1.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public InstrumentsController(Assignment1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentInstrument")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentInstrument")] Instrument instrument)
        {
            if (id != instrument.Id)
            {
                return NotFound();
